...
const ROLE_ROUTES: Record<Rol, string[]> = {
  ADMIN_GENERAL: ["*"],
  RESTAURANTE: ["/panel", "/mesas", "/pedidos", "/ventas", "/productos", "/clientes", "/cajas", "/usuarios", "/rrhh", "/compras", "/reportes", "/configuracion", "/perfil", "/ordenes", "/carta-qr", "/qr", "/kiosko-admin", "/cupones", "/planes", "/fotos", "/agente", "/apps-delivery"],

    ...
    <div className="-m-6 flex h-[calc(100vh-52px)] flex-col bg-[#f8f9fb]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={cn(
          ...
          {/* ── Cliente ── siempre visible; canje de puntos solo si puntosActivo ── */}
          <div className="flex-shrink-0 border-b border-stone-100 bg-white px-3 py-2">
            {clienteSeleccionado ? (
              <div className="flex items-center gap-2 rounded-xl bg-brand-50 border border-brand-200 px-3 py-2">
                <UserCircle size={16} className="text-brand-600 flex-shrink-0" />
                ...
                <button onClick={quitarCliente} className="rounded-lg p-1 hover:bg-brand-100 transition">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-stone-200 bg-stone-50 py-2 pl-8 pr-3 text-xs outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
                />
                {clienteSearch && (
            ...
            {/* Canje de puntos — solo si puntosActivo y cliente tiene puntos */}
            {puntosConfig?.activo && clienteSeleccionado && clienteSeleccionado.puntos > 0 && items.length > 0 && (

...
const Styles = () => (
  <style>{`
    ...
    .card:hover { transform: translateY(-4px) scale(1.015); filter: brightness(1.1); }
...
───────────────────────────────────────────────────────────── */
const Navbar = () => (
  <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:200, backdropFilter:"blur(24px)", background:"rgba(8,8,15,.82)", borderBottom:"1px solid rgba(255,255,255,.07)" }}>
...
const Hero = () => (
  <section style={{ minHeight:"100vh", display:"flex", alignItems:"center", paddingTop:80, paddingBottom:64, background:"#08080f", position:"relative", overflow:"hidden" }}>
    <Aurora />
    <Dots />
...
const SectionSolution = () => (
  <section id="como-funciona" style={{ padding:"96px 0", background:"#08080f", position:"relative", overflow:"hidden" }}>
    <Aurora op={0.55}/>
    <Dots op={0.45}/>
...
const SectionSystem = () => (
  <section id="sistema" style={{ padding:"96px 0", background:"#060609" }}>
    <div className="max-w-6xl mx-auto px-5 sm:px-8">
...
───────────────────────────────────────────────────────────── */
const Footer = () => (
  <footer style={{ background:"#040407", borderTop:"1px solid rgba(255,255,255,.06)", padding:"32px 0" }}>

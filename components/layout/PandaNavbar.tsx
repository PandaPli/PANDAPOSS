...
const modules: AppModule[] = [
  ...
  { label: "Pedidos", href: "/pedidos", icon: ClipboardList, color: "bg-gradient-to-br from-yellow-400 to-amber-500", roles: ["ADMIN_GENERAL", "RESTAURANTE", "SECRETARY", "CASHIER", "WAITER", "CHEF", "BAR", "DELIVERY"], category: "operacion", description: "Flujo activo de comandas y pedidos.", featured: true },

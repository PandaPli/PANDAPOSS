...
const modules: AppModule[] = [
  ...
  { label: "Mesas", href: "/mesas", icon: UtensilsCrossed, color: "bg-gradient-to-br from-orange-400 to-rose-500", roles: ["RESTAURANTE", "SECRETARY", "CASHIER", "WAITER"], category: "operacion", description: "Mesas, sala y servicio.", featured: true },
  { label: "Ordenes", href: "/delivery", icon: Bike, color: "bg-gradient-to-br from-amber-400 to-orange-500", roles: ["ADMIN_GENERAL", "RESTAURANTE", "DELIVERY"], category: "operacion", description: "Despachos y repartos.", featureKey: "delivery", featured: true },
  { label: "ODS", href: "/track", icon: Navigation, color: "bg-gradient-to-br from-cyan-500 to-sky-600", roles: ["ADMIN_GENERAL", "RESTAURANTE", "CASHIER", "DELIVERY"], category: "operacion", description: "Rastreo en vivo de pedidos delivery para clientes.", featureKey: "delivery" },
  ...
  { label: "KDS", href: "/pedidos", icon: ClipboardList, color: "bg-gradient-to-br from-yellow-400 to-amber-500", roles: ["ADMIN_GENERAL", "RESTAURANTE", "SECRETARY", "CASHIER", "WAITER", "CHEF", "BAR", "DELIVERY"], category: "operacion", description: "Flujo activo de comandas y pedidos.", featured: true },
  { label: "Llamador", href: "/llamador", icon: Tv2, color: "bg-gradient-to-br from-slate-600 to-slate-800", roles: ["ADMIN_GENERAL", "RESTAURANTE", "CASHIER"], category: "operacion", description: "Pantalla de TV: órdenes listas por sección (Cocina · Kiosko · Delivery)." },
  ...
  { label: "Prod. del Mes", href: "/producto-del-mes", icon: Star, color: "bg-gradient-to-br from-violet-500 to-purple-700", roles: ["ADMIN_GENERAL", "RESTAURANTE"], category: "configuracion", description: "Destacá un producto por sucursal en el menú QR." },

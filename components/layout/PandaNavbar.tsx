...
const modules: AppModule[] = [
  ...
  { label: "Ordenes", href: "/ordenes", icon: Star, color: "bg-gradient-to-br from-violet-500 to-purple-700", roles: ["ADMIN_GENERAL", "RESTAURANTE", "CASHIER"], category: "operacion", description: "Centro de pedidos: delivery, retiro y más." },

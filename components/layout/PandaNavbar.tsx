...
const modules: AppModule[] = [
  ...
  { label: "Ordenes", href: "/ordenes", icon: Star, color: "bg-gradient-to-br from-amber-400 to-orange-500", roles: ["ADMIN_GENERAL", "RESTAURANTE", "DELIVERY", "CASHIER"], category: "operacion", description: "Retiro y Delivery.", featured: true },
  ...
  { label: "Pagos MP", href: "/mp-pagos", icon: CreditCard, color: "bg-gradient-to-br from-sky-500 to-blue-600", roles: ["ADMIN_GENERAL", "RESTAURANTE"], category: "gestion", description: "Estado de transacciones MercadoPago y recuperación de pagos." },

...
const modules: AppModule[] = [
  ...
  { label: "Ordenes", href: "/ordenes", icon: Bike, color: "bg-gradient-to-br from-amber-400 to-orange-500", roles: ["ADMIN_GENERAL", "RESTAURANTE", "DELIVERY", "CASHIER"], category: "operacion", description: "Retiro y Delivery.", featured: true },

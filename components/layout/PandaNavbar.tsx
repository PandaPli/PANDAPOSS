...
const modules: AppModule[] = [
  ...
  { label: "Ordenes", href: "/ordenes", icon: Star, color: "bg-gradient-to-br from-violet-500 to-purple-700", roles: ["ADMIN_GENERAL", "RESTAURANTE", "DELIVERY", "CASHIER"], category: "operacion", description: "Hub de pedidos: delivery y para llevar.", featured: true },
